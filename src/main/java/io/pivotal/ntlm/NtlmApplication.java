...
public class NtlmApplication {

	public static void main(String[] args) {
		SpringApplication.run(NtlmApplication.class, args);
	}
    ...
    public static final class TrustEverythingHostNameVerifier implements HostnameVerifier {
    ...
    public static final class TrustEverythingTrustManager implements X509TrustManager {
